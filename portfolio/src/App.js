    ...
    <div>
      ...
      <div className="welcome">
        <div className="intro">
          <div>
            ...
            <div className="column">
              ...
              {/* PHONE NUMBER */}
              <p className="info">+47 415 59 061</p>
            </div>
            <div className="column">
              {/* EMAIL SVG */}
              ...
              {/* EMAIL ADDRESS */}
              <p className="info">markuslw10@icloud.com</p>
            </div>
            <div className="column">
              {/* LOCATION SVG */}
              ...
              {/* LOCATION */}
              <p className="info">Tromsø, Norway</p>
            </div>
          </div>
        ...
        <div className="column">
          ...
          <h3 className="organization">{content.education.university}</h3>
        </div>
        <div className="indent">
          <div className="table">
            <p className="position">{content.education.masters}</p>
            <p className="position">2026</p>
          </div>
          <div className="table">
            <p className="position">{content.education.bachelors}</p>
            <p className="position">2024</p>
          </div>
        </div>
        ...
        <Experience 
          logo={uitlogo_black}
          invert={true}
          title={content.experience.university.title}
          position={content.experience.university.position}
          description={content.experience.university.description}
          dates={Object.values(content.experience.university.date)} 
        />

        <Experience 
          logo={elkjoplogo}
          title={content.experience.elkjop.title}
          position={content.experience.elkjop.position}
          description={content.experience.elkjop.description}
          dates={[content.experience.elkjop.date]} 
        />

        <Experience 
          logo={tmlogo}
          icon_extras={true}
          title={content.experience.teknikmagasinet.title}
          position={content.experience.teknikmagasinet.position}
          description={content.experience.teknikmagasinet.description}
          dates={[content.experience.teknikmagasinet.date]} 
        />
        ...
        <Projects
          title={content.projects.procmon.title}
          date={content.projects.procmon.date}
          description={content.projects.procmon.description}
        />

        <Projects
          title={content.projects.freelance.title}
          date={content.projects.freelance.date}
          description={content.projects.freelance.description}
        />

        <Projects
          title={content.projects.bsc_thesis.title}
          date={content.projects.bsc_thesis.date}
          description={content.projects.bsc_thesis.description}
        />
